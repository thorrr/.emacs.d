...
(defun write-macro (name)                  
  "Write the last macro to *Messages*. Take a name as argument and save the last defined
macro under this name at the end of your .emacs"
